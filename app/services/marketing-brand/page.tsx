...
import business_inteligence from "@/public/assets/photos/marketing_and_brand.png";
      ...
      <section className="relative min-h-[60vh] bg-linear-to-br from-slate-900 via-blue-900 to-indigo-900 text-white flex justify-center items-center overflow-hidden pt-24 pb-16">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.button
              className="group relative bg-linear-to-r from-amber-500 to-yellow-600 text-white font-bold py-4 px-10 rounded-full overflow-hidden shadow-2xl"
              variants={itemVariants}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                Our approach to Marketing & Brand provides comprehensive solutions tailored to scale your operations and drive results. Here are the core focus areas:
              </p>
              <ul className="space-y-4">
                  ...
                  >
                    <div className="w-8 h-8 rounded-lg bg-linear-to-br from-amber-500 to-yellow-600 flex items-center justify-center shrink-0">
                      <FiCheck className="text-white" />
                    </div>
                    <span className="font-semibold text-slate-700">Marketing & Brand Strategy</span>
                  </motion.li>
                  <motion.li
                    key={1}
                    className="flex items-center gap-3 p-4 bg-white rounded-xl shadow-sm border border-gray-100"
                  ...
                  >
                    ...
                    <span className="font-semibold text-slate-700">Website Experience & SEO</span>
                  </motion.li>
                  <motion.li
                    key={2}
                    className="flex items-center gap-3 p-4 bg-white rounded-xl shadow-sm border border-gray-100"
                  ...
                  >
                    ...
                    <span className="font-semibold text-slate-700">Content & Storytelling</span>
                  </motion.li>
                  <motion.li
                    key={3}
                    className="flex items-center gap-3 p-4 bg-white rounded-xl shadow-sm border border-gray-100"
                  ...
                  >
                    ...
                    <span className="font-semibold text-slate-700">Sales Activation</span>
                  </motion.li>
              </ul>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 bg-linear-to-br from-amber-500 to-yellow-600 rounded-3xl transform rotate-3 opacity-20" />
        ...
        <div className="w-full max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-12 max-w-2xl mx-auto">
              Discover how our Marketing & Brand services have transformed businesses.
            </p>
