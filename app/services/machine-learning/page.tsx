...
export default function AIMachineLearningPage() {
  ...
  const toggleRequirement = (req: any) => {
    setFormData((prev) => ({
      ...prev,
      ...
      <section className="relative min-h-[80vh] bg-linear-to-br from-brand-deep to-brand-blue text-white flex justify-center items-center overflow-hidden pt-24 pb-16">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              <FiCpu className="text-sky-400 mr-2" />
            ...
            <motion.button
              className="group relative bg-brand-orange hover:bg-brand-orange/90 text-white font-bold py-4 px-10 rounded-full overflow-hidden shadow-2xl"
              variants={itemVariants}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                Our approach to AI & Machine Learning provides comprehensive solutions tailored to scale your operations and drive results. Here are the core focus areas:
              </p>
        ...
        <div className="w-full max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-12 max-w-2xl mx-auto">
              Discover how our AI & Machine Learning services have transformed businesses.
            </p>
          ...
          >
            ...
            <div className="pt-4">
              ...
              >
                ...
                {!isSubmitting && <div className="absolute inset-0 bg-linear-to-r from-brand-orange to-[#e67900] opacity-0 group-hover:opacity-100 transition-opacity" />}
              </motion.button>
